...
const MovieDetailsPage = () => {
    ...
    return (
        <div className="page-container text-white">
            ...
            {/* <MovieMeta type={"/credits"}></MovieMeta>;<MovieMeta type={"/videos"}></MovieMeta>;
...
function MovieCredits() {
    return <MovieMeta type={"/credits"}></MovieMeta>;
}

function MovieVideo() {
    return <MovieMeta type={"/videos"}></MovieMeta>;
}

function MovieSimilar() {
    return <MovieMeta type={"/similar"}></MovieMeta>;
}
