    ...
    return (
        <>
            ...
            <div className="fixed top-3 right-3 z-50">
                <div className="relative w-20 h-9 flex items-center cursor-pointer rounded-full bg-primary">
                    <div className={`absolute w-8 h-8 rounded-full bg-white right-0`}></div>
                </div>
            </div>
        </>
    );
