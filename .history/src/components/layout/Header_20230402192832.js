    ...
    return (
        <>
            ...
            <div className="fixed top-3 right-3 z-50">
                <div className="relative w-20 h-10 flex items-center cursor-pointer rounded-full bg-primary">
                    <div className={`absolute w-9 h-9 rounded-full bg-white right-0`}></div>
                </div>
            </div>
        </>
    );
