...
const Banner = () => {
    const { data } = useSWR(getMovieList("upcoming"), fetcher);
        ...
        <div className="w-full h-full rounded-lg relative">
            ...
            <div className="absolute left-5 bottom-5 w-full text-white">
                ...
                <button
                    ...
                    className="py-3 flex items-center justify-center gap-x-3 px-6 rounded-lg bg-primary text-xl text-white font-bold"
                >
                    <span>Watch Now</span>
